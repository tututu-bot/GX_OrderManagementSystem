...
-- ============================================================
-- 初始化商品数据
-- 共84个商品: 42#型号36个 + 37#型号30个 + 32#型号18个
-- 编码规则: {颜色首字母}{品类}{型号}-{规格数字}
--   B = 白(White), H = 黑(Black)
--   ZZ = 针织
--   例: BZZ-42-19 = 针织42# 白 1.9cm/6分 码数45y
-- specification 格式: 颜色;尺码;备注 (以;分隔)
-- ============================================================

-- 针织42# 码数45y (18规格 × 2颜色 = 36个)
INSERT OR IGNORE INTO product(product_code, product_name, specification, unit, unit_price, remark) VALUES
('BZZ-42-19-1',  '针织42#', '白;1.9cm/6分;码数45y',   '公斤', 5.5,  NULL),
('HZZ-42-19-1',  '针织42#', '黑;1.9cm/6分;码数45y',   '公斤', 6.0,  NULL),
('BZZ-42-22-1',  '针织42#', '白;2.2cm/7分;码数45y',   '公斤', 6.6,  NULL),
('HZZ-42-22-1',  '针织42#', '黑;2.2cm/7分;码数45y',   '公斤', 7.0,  NULL),
('BZZ-42-25-1',  '针织42#', '白;2.5cm/1寸;码数45y',   '公斤', 7.5,  NULL),
('HZZ-42-25-1',  '针织42#', '黑;2.5cm/1寸;码数45y',   '公斤', 8.0,  NULL),
('BZZ-42-30-1',  '针织42#', '白;3.0cm/1寸1分;码数45y', '公斤', 8.9,  NULL),
('HZZ-42-30-1',  '针织42#', '黑;3.0cm/1寸1分;码数45y', '公斤', 9.5,  NULL),
('BZZ-42-32-1',  '针织42#', '白;3.2cm/1寸2分;码数45y', '公斤', 9.5,  NULL),
('HZZ-42-32-1',  '针织42#', '黑;3.2cm/1寸2分;码数45y', '公斤', 10.2, NULL),
('BZZ-42-35-1',  '针织42#', '白;3.5cm/1寸3分;码数45y', '公斤', 10.5, NULL),
('HZZ-42-35-1',  '针织42#', '黑;3.5cm/1寸3分;码数45y', '公斤', 11.2, NULL),
('BZZ-42-38-1',  '针织42#', '白;3.8cm/1寸半;码数45y',  '公斤', 11.4, NULL),
('HZZ-42-38-1',  '针织42#', '黑;3.8cm/1寸半;码数45y',  '公斤', 12.0, NULL),
('BZZ-42-40-1',  '针织42#', '白;4.0cm/1寸5分;码数45y', '公斤', 12.0, NULL),
('HZZ-42-40-1',  '针织42#', '黑;4.0cm/1寸5分;码数45y', '公斤', 12.8, NULL),
('BZZ-42-45-1',  '针织42#', '白;4.5cm/1寸6分;码数45y', '公斤', 13.3, NULL),
('HZZ-42-45-1',  '针织42#', '黑;4.5cm/1寸6分;码数45y', '公斤', 14.2, NULL),
('BZZ-42-50-1',  '针织42#', '白;5.0cm/2寸;码数45y',    '公斤', 15.0, NULL),
('HZZ-42-50-1',  '针织42#', '黑;5.0cm/2寸;码数45y',    '公斤', 16.0, NULL),
('BZZ-42-57-1',  '针织42#', '白;5.7cm/2寸2分;码数45y', '公斤', 18.5, NULL),
('HZZ-42-57-1',  '针织42#', '黑;5.7cm/2寸2分;码数45y', '公斤', 19.5, NULL),
('BZZ-42-63-1',  '针织42#', '白;6.3cm/2寸半;码数45y',  '公斤', 20.5, NULL),
('HZZ-42-63-1',  '针织42#', '黑;6.3cm/2寸半;码数45y',  '公斤', 21.8, NULL),
('BZZ-42-70-1',  '针织42#', '白;7.0cm/2寸6分;码数45y', '公斤', 22.0, NULL),
('HZZ-42-70-1',  '针织42#', '黑;7.0cm/2寸6分;码数45y', '公斤', 23.0, NULL),
('BZZ-42-76-1',  '针织42#', '白;7.6cm/3寸;码数45y',    '公斤', 24.5, NULL),
('HZZ-42-76-1',  '针织42#', '黑;7.6cm/3寸;码数45y',    '公斤', 26.0, NULL),
('BZZ-42-80-1',  '针织42#', '白;8.0cm/3寸1分;码数45y', '公斤', 26.0, NULL),
('HZZ-42-80-1',  '针织42#', '黑;8.0cm/3寸1分;码数45y', '公斤', 28.0, NULL),
('BZZ-42-90-1',  '针织42#', '白;9.0cm/3寸半;码数45y',  '公斤', 38.0, NULL),
('HZZ-42-90-1',  '针织42#', '黑;9.0cm/3寸半;码数45y',  '公斤', 40.0, NULL),
('BZZ-42-100-1', '针织42#', '白;10.0cm/4寸;码数45y',   '公斤', 44.0, NULL),
('HZZ-42-100-1', '针织42#', '黑;10.0cm/4寸;码数45y',   '公斤', 46.0, NULL),
('BZZ-42-150-1', '针织42#', '白;15.0cm/6寸;码数45y',   '公斤', 72.0, NULL),
('HZZ-42-150-1', '针织42#', '黑;15.0cm/6寸;码数45y',   '公斤', 72.0, NULL);

-- 针织37# 码数95y/41y (15规格 × 2颜色 = 30个)
INSERT OR IGNORE INTO product(product_code, product_name, specification, unit, unit_price, remark) VALUES
('BZZ-37-10-1',  '针织37#', '白;1.0cm/3分;码数95y',    '公斤', 12.0, NULL),
('HZZ-37-10-1',  '针织37#', '黑;1.0cm/3分;码数95y',    '公斤', 13.0, NULL),
('BZZ-37-12-1',  '针织37#', '白;1.2cm/4分;码数95y',    '公斤', 14.0, NULL),
('HZZ-37-12-1',  '针织37#', '黑;1.2cm/4分;码数95y',    '公斤', 15.0, NULL),
('BZZ-37-15-1',  '针织37#', '白;1.5cm/5分;码数95y',    '公斤', 16.0, NULL),
('HZZ-37-15-1',  '针织37#', '黑;1.5cm/5分;码数95y',    '公斤', 17.0, NULL),
('BZZ-37-19-1',  '针织37#', '白;1.9cm/6分;码数41y',    '公斤', 6.4,  NULL),
('HZZ-37-19-1',  '针织37#', '黑;1.9cm/6分;码数41y',    '公斤', 6.8,  NULL),
('BZZ-37-22-1',  '针织37#', '白;2.2cm/7分;码数41y',    '公斤', 7.4,  NULL),
('HZZ-37-22-1',  '针织37#', '黑;2.2cm/7分;码数41y',    '公斤', 8.0,  NULL),
('BZZ-37-25-1',  '针织37#', '白;2.5cm/1寸;码数41y',    '公斤', 8.2,  NULL),
('HZZ-37-25-1',  '针织37#', '黑;2.5cm/1寸;码数41y',    '公斤', 9.0,  NULL),
('BZZ-37-30-1',  '针织37#', '白;3.0cm/1寸1分;码数41y', '公斤', 9.8,  NULL),
('HZZ-37-30-1',  '针织37#', '黑;3.0cm/1寸1分;码数41y', '公斤', 10.8, NULL),
('BZZ-37-32-1',  '针织37#', '白;3.2cm/1寸2分;码数41y', '公斤', 10.2, NULL),
('HZZ-37-32-1',  '针织37#', '黑;3.2cm/1寸2分;码数41y', '公斤', 10.9, NULL),
('BZZ-37-35-1',  '针织37#', '白;3.5cm/1寸3分;码数41y', '公斤', 11.5, NULL),
('HZZ-37-35-1',  '针织37#', '黑;3.5cm/1寸3分;码数41y', '公斤', 12.4, NULL),
('BZZ-37-38-1',  '针织37#', '白;3.8cm/1寸半;码数41y',  '公斤', 12.5, NULL),
('HZZ-37-38-1',  '针织37#', '黑;3.8cm/1寸半;码数41y',  '公斤', 13.5, NULL),
('BZZ-37-40-1',  '针织37#', '白;4.0cm/1寸5分;码数41y', '公斤', 13.3, NULL),
('HZZ-37-40-1',  '针织37#', '黑;4.0cm/1寸5分;码数41y', '公斤', 14.2, NULL),
('BZZ-37-45-1',  '针织37#', '白;4.5cm/1寸6分;码数41y', '公斤', 14.5, NULL),
('HZZ-37-45-1',  '针织37#', '黑;4.5cm/1寸6分;码数41y', '公斤', 15.5, NULL),
('BZZ-37-50-1',  '针织37#', '白;5.0cm/2寸;码数41y',    '公斤', 16.5, NULL),
('HZZ-37-50-1',  '针织37#', '黑;5.0cm/2寸;码数41y',    '公斤', 17.5, NULL),
('BZZ-37-57-1',  '针织37#', '白;5.7cm/2寸2分;码数41y', '公斤', 20.5, NULL),
('HZZ-37-57-1',  '针织37#', '黑;5.7cm/2寸2分;码数41y', '公斤', 22.0, NULL),
('BZZ-37-63-1',  '针织37#', '白;6.3cm/2寸半;码数41y',  '公斤', 22.5, NULL),
('HZZ-37-63-1',  '针织37#', '黑;6.3cm/2寸半;码数41y',  '公斤', 24.0, NULL);

-- 针织32# 码数40y (9规格 × 2颜色 = 18个)
INSERT OR IGNORE INTO product(product_code, product_name, specification, unit, unit_price, remark) VALUES
('BZZ-32-19-1',  '针织32#', '白;1.9cm/6分;码数40y',    '公斤', 7.7,  NULL),
('HZZ-32-19-1',  '针织32#', '黑;1.9cm/6分;码数40y',    '公斤', 8.1,  NULL),
('BZZ-32-25-1',  '针织32#', '白;2.5cm/1寸;码数40y',    '公斤', 10.0, NULL),
('HZZ-32-25-1',  '针织32#', '黑;2.5cm/1寸;码数40y',    '公斤', 10.7, NULL),
('BZZ-32-30-1',  '针织32#', '白;3.0cm/1寸1分;码数40y', '公斤', 12.0, NULL),
('HZZ-32-30-1',  '针织32#', '黑;3.0cm/1寸1分;码数40y', '公斤', 12.8, NULL),
('BZZ-32-32-1',  '针织32#', '白;3.2cm/1寸2分;码数40y', '公斤', 12.3, NULL),
('HZZ-32-32-1',  '针织32#', '黑;3.2cm/1寸2分;码数40y', '公斤', 13.2, NULL),
('BZZ-32-35-1',  '针织32#', '白;3.5cm/1寸3分;码数40y', '公斤', 13.9, NULL),
('HZZ-32-35-1',  '针织32#', '黑;3.5cm/1寸3分;码数40y', '公斤', 14.8, NULL),
('BZZ-32-38-1',  '针织32#', '白;3.8cm/1寸半;码数40y',  '公斤', 14.8, NULL),
('HZZ-32-38-1',  '针织32#', '黑;3.8cm/1寸半;码数40y',  '公斤', 15.8, NULL),
('BZZ-32-40-1',  '针织32#', '白;4.0cm/1寸5分;码数40y', '公斤', 15.5, NULL),
('HZZ-32-40-1',  '针织32#', '黑;4.0cm/1寸5分;码数40y', '公斤', 16.5, NULL),
('BZZ-32-45-1',  '针织32#', '白;4.5cm/1寸6分;码数40y', '公斤', 17.5, NULL),
('HZZ-32-45-1',  '针织32#', '黑;4.5cm/1寸6分;码数40y', '公斤', 18.8, NULL),
('BZZ-32-50-1',  '针织32#', '白;5.0cm/2寸;码数40y',    '公斤', 19.0, NULL),
('HZZ-32-50-1',  '针织32#', '黑;5.0cm/2寸;码数40y',    '公斤', 20.0, NULL);
